...
class ServerUserListItem extends React.Component {
  render() {
    const crown = this.props.admin ? (
      <svg
        aria-label="Server Owner"
        name="Crown"
        className="server-admin-crown"
        width="24"
        height="24"
        viewBox="0 0 16 16"
      >
        ...
        <div className="server-user-list-content-wrapper">
          ...
          <div className="server-user-list-name">
            <div className="server-user-list-name-wrapper">
              <div className="server-user-list-inner">
                <span className="server-user-list-username">
                  {this.props.username}
                </span>
                {crown}
              </div>
